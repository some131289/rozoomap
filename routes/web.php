...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('disciplines', 'Admin\DisciplinesController');
    Route::post('disciplines_mass_destroy', ['uses' => 'Admin\DisciplinesController@massDestroy', 'as' => 'disciplines.mass_destroy']);
    Route::post('disciplines_restore/{id}', ['uses' => 'Admin\DisciplinesController@restore', 'as' => 'disciplines.restore']);
    Route::delete('disciplines_perma_del/{id}', ['uses' => 'Admin\DisciplinesController@perma_del', 'as' => 'disciplines.perma_del']);
