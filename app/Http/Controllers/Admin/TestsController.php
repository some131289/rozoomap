...
class TestsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.tests.create', compact('categories', 'questions'));
    }
    ...
    public function store(StoreTestsRequest $request)
    {
        ...
        $test->question()->sync(array_filter((array)$request->input('question')));
    ...
    public function edit($id)
    {
        ...
        return view('admin.tests.edit', compact('test', 'categories', 'questions'));
    }
